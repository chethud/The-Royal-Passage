    ...
    <div className="experience-detail-page min-h-screen pt-[var(--header-height)] text-ink">
      ...
      <section className="container-page grid gap-8 pb-14 md:grid-cols-2 md:items-start md:gap-8 lg:gap-10">
        ...
        <div className="flex w-full min-w-0 flex-col md:pt-2">
          ...
          {locationLine || stay.address || stay.mapLink ? (
            <div className="flex items-start gap-2 text-sm text-brand-cotton/90">
              ...
              <div>
                ...
                {stay.address ? <div className="mt-0.5 text-brand-cotton/75">{stay.address}</div> : null}
                {stay.mapLink ? (
                  <a
                    href={stay.mapLink}
                    target="_blank"
          ...
          <h1 className="mt-5 font-display text-3xl uppercase leading-[1.08] tracking-[0.04em] text-ink sm:text-4xl md:text-[2.65rem]">
            {stay.title}
          </h1>
          ...
          <dl className="grid grid-cols-3 divide-x divide-[rgb(201_162_39/0.28)] text-center sm:text-left">
            ...
            <div className="px-2 sm:px-5">
              ...
              <dd className="mt-1.5 font-display text-xl uppercase tracking-[0.02em] text-ink">
                <BedDouble className="mx-auto h-5 w-5 text-gold sm:mx-0" aria-hidden />
                {stay.bedrooms}
              </dd>
            </div>
          ...
          <div className="mt-8">
            <div className="eyebrow mb-3 text-gold">About this stay</div>
            <p className="text-sm leading-relaxed text-brand-cotton/90">{stay.description}</p>
          </div>

          {stay.amenities.length > 0 ? (
            <div className="mt-8">
              <div className="eyebrow mb-3 text-gold">Amenities</div>
              <div className="flex flex-wrap gap-2">
                {stay.amenities.map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-[rgb(201_162_39/0.35)] px-3 py-1 text-[0.65rem] uppercase tracking-[0.12em] text-brand-cotton/90"
                  >
                    {item}
                  </span>
                ))}
          ...
          <div className="mt-8 flex items-center gap-2 text-sm text-brand-cotton/85">
      ...
      <section id="book" className="border-t border-[rgb(201_162_39/0.18)] pb-16 pt-4">
