  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-xl self-start">
        <div className="relative z-10 mb-5 inline-flex max-w-full flex-col items-stretch">
          <p className="royal-slide-eyebrow mb-4 text-[0.62rem] font-medium uppercase tracking-[0.38em] text-[#C9A227] sm:text-[0.68rem]">
            {slide.subtitle}
          </p>
          <div
