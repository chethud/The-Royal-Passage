...
export function HomestaysHero({ searchValue, onSearchChange }: HomestaysHeroProps) {
  ...
  return (
    <section className="relative min-h-[36vh] overflow-hidden md:min-h-[42vh]">
      <div
      ...
      <div className="container-page relative z-10 flex min-h-[36vh] flex-col justify-center pb-10 pt-[calc(var(--header-height)+1.25rem)] md:min-h-[42vh] md:pb-12">
        <motion.div
          ...
          className="w-full"
        >
          <p className="eyebrow text-[#D4AF6A]">Royal Homestays</p>

          <div className="mt-2 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between lg:gap-8">
            <div className="min-w-0 max-w-2xl">
              <h1 className="font-display text-3xl leading-tight tracking-tight text-[#F7F1E8] sm:text-4xl md:text-[2.75rem]">
                Stay in Mysuru, Royally
              </h1>
