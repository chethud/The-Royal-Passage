  ...
  return (
    <section className="border-t border-[oklch(0.88_0.08_86_/_0.12)] bg-[oklch(0.13_0.06_22)] py-8 sm:py-14 md:py-16">
      <div className="container-page px-2 sm:px-6">
        ...
        <div className="grid grid-cols-4 gap-1 sm:gap-4 md:gap-6 lg:gap-8">
            ...
            return (
              ...
              >
                <span className="mb-2 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-ember/55 bg-ember/8 text-ember shadow-[inset_0_1px_0_oklch(0.92_0.06_82_/_0.18)] sm:mb-5 sm:h-16 sm:w-16">
                  <Icon className="h-4 w-4 sm:h-8 sm:w-8" strokeWidth={1.4} />
                </span>
                <div className="font-display text-[0.52rem] uppercase leading-tight tracking-[0.08em] text-ink sm:text-[0.95rem] sm:tracking-[0.2em]">
                  {pillar.title}
                </div>
                <p className="mt-1 max-w-none text-[0.5rem] leading-snug text-muted-foreground sm:mt-2 sm:max-w-[16rem] sm:text-[0.78rem] sm:leading-relaxed">
                  {pillar.description}
                </p>
              </motion.div>
            );
