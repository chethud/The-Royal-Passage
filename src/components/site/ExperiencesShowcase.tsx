...
import { ArrowRight, Flame, Landmark, Palette, type LucideIcon } from "lucide-react";
      ...
      <div className="container-page">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground text-balance sm:text-[0.95rem]">
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="absolute left-4 top-4 flex h-10 w-10 items-center justify-center rounded-full border border-ember/45 bg-background/55 text-ember backdrop-blur-md">
