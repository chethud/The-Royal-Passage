...
export function ExperiencesFilterSidebar({
  ...
  return (
    <aside className="order-1 w-full shrink-0 lg:w-[220px] xl:w-[240px]">
      {/* Mobile: always-visible compact filters */}
      <div className="lg:hidden">
        <div className="mb-3 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={onReset}
              className="shrink-0 px-1.5 py-1 text-[0.65rem] uppercase tracking-[0.14em] text-[#D4AF6A]/85 transition-colors hover:text-[#F7F1E8]"
            >
              Reset
            </button>
          </div>
        ...
        <div className="space-y-4 rounded-sm border border-[rgb(200_162_90/0.22)] bg-[rgb(0_0_0/0.18)] px-3 py-3">
