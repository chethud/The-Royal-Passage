...
from app.http_api import (
    ...
    admin_site_banners,
    admin_stats,
    admin_upsert_site_banner,
    admin_users,
    healthz,
    public_active_site_banners,
)
...
core_app = Starlette(
    routes=[
        ...
        Route("/api/v1/admin/risk-signals", admin_risk_signals, methods=["GET"]),
        Route("/api/v1/admin/banners", admin_site_banners, methods=["GET"]),
        Route("/api/v1/admin/banners", admin_upsert_site_banner, methods=["POST"]),
        Route("/api/v1/admin/banners/{banner_id}", admin_delete_site_banner, methods=["DELETE"]),
        Route("/api/v1/banners/active", public_active_site_banners, methods=["GET"]),
