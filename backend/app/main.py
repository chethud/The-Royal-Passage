...
from app.http_api import (
    ...
    admin_experiences,
    admin_hide_experience_review,
    admin_hide_homestay_review,
    admin_homestay_bookings,
    admin_homestay_stats,
    admin_moderation_reviews,
...
core_app = Starlette(
    routes=[
        ...
        Route("/api/v1/admin/moderation-reviews", admin_moderation_reviews, methods=["GET"]),
        Route(
            "/api/v1/admin/moderation-reviews/experience/{review_id}/hide",
            admin_hide_experience_review,
            methods=["POST"],
        ),
        Route(
            "/api/v1/admin/moderation-reviews/homestay/{review_id}/hide",
            admin_hide_homestay_review,
            methods=["POST"],
        ),
